...
2. [PKI/Certificate Authority Configuration](#pkicertificate-authority-configuration)
   - 2.1 [Overview and Hierarchy](#overview-and-hierarchy)
   - 2.2 [PKI Architecture and Roles](#pki-architecture-and-roles)
   - 2.3 [Trust Chain and Workflow](#trust-chain-and-workflow)
   - 2.4 [X.509 Certificate Profile](#x509-certificate-profile)
   - 2.5 [Operational Considerations](#operational-considerations)
   - 2.6 [Active Directory Certificate Services](#active-directory-certificate-services)
3. [Identity and Access Management](#identity-and-access-management)
   - 3.1 [Authentik Identity Stack](#authentik-identity-stack)
   - 3.2 [Microsoft Active Directory](#microsoft-active-directory)
   - 3.3 [User and Group Policy Management](#user-and-group-policy-management)
4. [Secrets Management](#secrets-management)
   - 4.1 [Vaultwarden Password Manager](#vaultwarden-password-manager)
...
10. [Security Homelab Section Links](#security-homelab-section-links)
